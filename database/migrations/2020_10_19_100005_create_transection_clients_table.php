...
class CreateTransectionClientsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transection_clients', function (Blueprint $table) {
           $table->id();
    ...
    {
        Schema::dropIfExists('transection_clients');
    }
}
